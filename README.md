...
# --- allow all 10.0.0.0/8 traffic (Kubernetes pods + services) --- (Add before last COMMIT)
 
-A ufw-before-forward -s 10.0.0.0/8 -j ACCEPT
-A ufw-before-forward -d 10.0.0.0/8 -j ACCEPT
